...
local isCloseEnough = function(new, target, range)
	if (range > 0) then
...
local bar_SetSmoothedValue = function(self, value)
...
local bar_SetSmoothedMinMaxValues = function(self, min, max)
...
local DesmoothBar = function(bar)
